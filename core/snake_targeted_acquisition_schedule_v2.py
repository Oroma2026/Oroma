...
# -*- coding: utf-8 -*-
# =============================================================================
# Pfad:    /opt/ai/oroma/core/snake_targeted_acquisition_schedule_v2.py
# Projekt: ORÓMA (Offline-First · Headless · Vertical Learning Governance)
# Modul:   Snake Targeted Acquisition Schedule – Food-Directed v2 Dry Run
# Version: v0.2.0-food-directed-schedule
# Stand:   2026-07-16
...
# ZWECK
# ─────
# Dieses Modul führt denselben begrenzten 12/24/48-Versuchsplan wie die
# Referenz-Schedule v1 aus, variiert jedoch ausschließlich das Continuation
# Protocol nach dem unverändert erzwungenen Promotion-Schritt. Die Fortsetzung
# verwendet ``snake_continuation:safe_food_directed_v2``.
#
# EXPERIMENTELLE ISOLATION
# ────────────────────────
#   • Evidence bleibt ausschließlich echtes Food-, Target- oder Death-Event.
#   • Keine Proximity-Credits und kein Reward Shaping.
#   • Keine Datenbank-, Lifecycle-, Queue-, Promotion- oder Policy-Mutation.
#   • Neue Schedule-ID und neuer Digest verhindern jede Vermischung mit v1.
#   • Schritt-, Laufzeit- und Versuchsbudgets bleiben identisch zu v1.
# =============================================================================
...
from core.snake_food_directed_continuation import PROTOCOL_ID
...
VERSION = "v0.2.0-food-directed-schedule"
SCHEDULE_ID = "snake_targeted_acquisition:food_directed_v2"
...
def build_schedule_descriptor(
    ...
    payload = {
        ...
        "evidence_semantics": "direct_food_target_or_death_only",
    }
    return payload, canonical_sha256(payload)


def run_food_directed_acquisition_schedule(
    *,
    ...
    return {
        ...
        "summary": {
            ...
            "direct_outcome_acquired": False,
            "exhausted": True,
            "terminal_reason": "food_directed_schedule_completed_without_direct_outcome",
            "dt_ms": round((time.monotonic() - started) * 1000.0, 3),
        },
    }
